...
public class ClientTest {
	...
	private static final String urls[] = new String[] {
		"http://google.com", "http://www.yahoo.com", "http://neverssl.com", "http://info.cern.ro"
	};
...
//		}
		...
		String page = cache.requestURL(urls[0]);
		System.out.println(urls[0]);
		try { Thread.sleep(1000); } catch (Throwable t) { }

		page = cache.requestURL(urls[0]);
		System.out.println(urls[0]);
		try { Thread.sleep(1000); } catch (Throwable t) { }

		page = cache.requestURL(urls[2]);
		System.out.println(urls[2]);
		try { Thread.sleep(1000); } catch (Throwable t) { }

		page = cache.requestURL(urls[3]);
