...
formal: TYPE ID;
definition:
    TYPE ID (ASSIGN expr)?                                        # variableDef
    | TYPE ID LPAREN (formal COMMA?)* RPAREN LBRACE expr RBRACE   # functionDef
	;
...
expr
    :
    LPAREN expr RPAREN                                              # paranExpr
    |   MINUS expr                                                  # unaryOperator
    |   expr MULT expr                                              # multExpr
    |   expr DIV expr                                               # divExpr
    |   expr PLUS expr                                              # plusExpr
    |   expr MINUS expr                                             # minusExpr
    |   ID LPAREN (expr COMMA?)* RPAREN                             # functionCall
    |   ID ASSIGN expr                                              # assign
    |   expr (LT | LE | EQUAL) expr                                 # relationalExpr
