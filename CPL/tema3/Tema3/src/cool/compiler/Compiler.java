...
public class Compiler {
    ...
    public static void main(String[] args) throws IOException {
        ...
        var astConstructorVisitor =  new ASTConstructorVisitor();
        var ast = astConstructorVisitor.visit(globalTree);

        var astDefinitionPassVisitor = new DefinitionPassVisitor();
        ast.accept(astDefinitionPassVisitor);

        var astTypeDefinitionsVisitor = new TypeDefinitionsVisitor();
        ast.accept(astTypeDefinitionsVisitor);

        var astResolutionPassVisitor = new ResolutionPassVisitor();
        ast.accept(astResolutionPassVisitor);
        ...
        ST generatedCode = ast.accept(codeGenVisitor);
        System.out.println(generatedCode.render());
    }
}
